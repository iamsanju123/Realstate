...
export const listOfProjectDetail = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { projectDetailId } = req.params;
        const response = yield listOfProjectDetailService(projectDetailId);
        if (!response) {
