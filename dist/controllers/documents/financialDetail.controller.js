...
export const listOfFinancialDetails = asyncHandler((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { financialId } = req.params;
        const response = yield listOfFinancialDetailsService(financialId);
        if (!response) {
