...
export const listOfLandDetailService = (landDetailId) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        if (!landDetailId) {
            return new ApiResponse(404, "land detail Id is not found", false, null);
        }
        const landData = yield LandDetail.findOne({ landDetailId: landDetailId });
        if (landData && landData._id) {
            return new ApiResponse(200, "data is successfully fetched", true, landData);
        }
        const createLandData = yield LandDetail.create({
